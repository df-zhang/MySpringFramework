...
public class CustomAnnotationScanner {  
    ...
    protected final Logger logger = Logger.getLogger(CustomAnnotationScanner.class);
     ...
     */  
    public CustomAnnotationScanner(String[] packagesToScan, @SuppressWarnings("unchecked") Class<? extends Annotation>... annotationFilter){  
